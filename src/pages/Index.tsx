...
const STATS_DATA = [
  {
    category: "1. Частота занятий спортом",
    source: "Минспорт РФ, 2024; ВЦИОМ, 2023",
    rows: [
      { label: "Доля систематически занимающихся физкультурой и спортом", value: 60 },
      { label: "Занимаются спортом 1–3 раза в неделю", value: 54 },
      { label: "Занимаются спортом ежедневно", value: 18 },
      { label: "Не занимаются спортом совсем", value: 28 },
    ],
  },
  {
    category: "2. Причины занятий спортом",
    source: "ВЦИОМ, 2023",
    rows: [
      { label: "Укрепление и поддержание здоровья", value: 70 },
      { label: "Сохранение или улучшение физической формы", value: 20 },
      { label: "Формирование здорового образа жизни", value: 19 },
      { label: "Улучшение настроения и получение удовольствия", value: 18 },
      { label: "Нехватка времени как барьер для занятий", value: 40 },
      { label: "Состояние здоровья как барьер для занятий", value: 36 },
    ],
  },
  {
    category: "3. Оценка личного влияния спорта",
    source: "ВЦИОМ, 2023; ФОМ, 2023",
    rows: [
      { label: "Считают спорт важным для здоровья и самочувствия", value: 63 },
      { label: "Отмечают положительное влияние спорта на экономику", value: 65 },
      { label: "Удовлетворены условиями для занятий спортом", value: 70 },
      { label: "Используют спорт для улучшения настроения", value: 12 },
    ],
  },
];
...
const CONCLUSIONS = [
  {
    number: "01",
    title: "Спорт охватывает большинство, но не всех",
    text: "По данным Минспорта РФ (2024), доля систематически занимающихся достигла 60,3% — исторического максимума. Однако 28% россиян не занимаются спортом совсем, что указывает на сохраняющиеся барьеры: нехватку времени (40%) и состояние здоровья (36%).",
  },
  {
    number: "02",
    title: "Здоровье — главная мотивация",
    text: "Подавляющее большинство занимающихся (70%) называют укрепление здоровья основной причиной. Среди граждан старше 60 лет этот показатель достигает 80%. Социальные и эмоциональные мотивы (улучшение настроения, общение) пока остаются вторичными — 18%.",
  },
  {
    number: "03",
    title: "Спорт формирует позитивный общественный климат",
    text: "65% россиян признают положительное влияние спорта на экономику страны, 70% удовлетворены доступностью спортивной инфраструктуры. Это свидетельствует о росте общественного признания спорта как фактора социальной сплочённости.",
  },
];

const RECOMMENDATIONS = [
  "Развивать доступную спортивную инфраструктуру в малых городах и сельской местности для снижения барьера «нет условий».",
  "Внедрять корпоративные программы здоровья на предприятиях для преодоления барьера «нехватка времени» среди работающего населения.",
  "Разработать адаптированные спортивные программы для граждан с ограничениями здоровья — одного из ключевых барьеров (36%).",
  "Проводить регулярные социологические исследования динамики спортивной активности для оценки эффективности государственных программ.",
];
      ...
      {STATS_DATA.map((group, gi) => (
        <div key={gi} className="mb-10">
          <div className="flex items-baseline justify-between mb-5">
            <h3
              className="font-ibm text-xs uppercase"
              style={{ color: "var(--gold)", letterSpacing: "0.15em" }}
            >
              {group.category}
            </h3>
            {"source" in group && (
              <span className="font-ibm text-xs" style={{ color: "var(--text-muted)" }}>
                Источник: {(group as typeof group & { source: string }).source}
              </span>
            )}
          </div>
    ...
    <div className="min-h-screen" style={{ background: "var(--surface)" }}>
          ...
          <div className="flex items-start justify-between gap-6">
            <div>
              ...
              <h1 className="font-cormorant text-4xl md:text-5xl font-semibold leading-tight text-white mb-3">
                Спортивные движения<br />
                <span style={{ color: "var(--gold-light)" }}>и общественная жизнь</span>
              </h1>
              <p className="font-ibm text-sm font-light" style={{ color: "rgba(255,255,255,0.5)" }}>
                Анализ частоты занятий, причин и личного влияния спорта на основе данных ВЦИОМ, Минспорта РФ, Росстата и ФОМ
              </p>
            </div>
      ...
      <div className="max-w-5xl mx-auto px-6 pt-10 pb-2">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          {[
            { value: "60%", label: "Занимаются систематически", icon: "Activity" },
            { value: "70%", label: "Мотив — здоровье", icon: "Heart" },
            { value: "65%", label: "Влияние на экономику", icon: "TrendingUp" },
